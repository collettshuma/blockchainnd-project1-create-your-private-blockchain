...
class Blockchain {
    ...
    requestMessageOwnershipVerification(address) {
        return new Promise((resolve) => {
            let unsignedMessage;
            unsignedMessage=address + ":" + new Date().getTime().toString().slice(0,-3) + ":starRegistry";
     ...
     */
     ...
     submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
          ...
          //reject on timeout
          switch(true){
            case currentTime - requestTime  > 300 :
          ...
          //
          switch(true){
            case bitcoinMessage.verify(message, address, signature) == false:
     ...
     validateChain() {
        ...
        return new Promise(async (resolve, reject) => {
          ...
          self.chain.forEach(async function(block, height) {
              ...
              switch(true){
                  case block.previousBlockHash != previousBlockHash:
